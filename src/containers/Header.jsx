...
const Header = () => {
  ...
  const cargarProductos = async () => {
    try {
      ...
      const response = await axios.get("https://backendmitiendita.onrender.com/api/v1/inventario", { headers });
  ...
  const eliminarProducto = async (id) => {
    try {
      ...
      await axios.delete(`https://backendmitiendita.onrender.com/api/v1/inventario/${id}`, { headers });
  ...
  const editarProducto = async (id, productoEditado) => {
    try {
      ...
      await axios.patch(`https://backendmitiendita.onrender.com/api/v1/inventario/${id}`, productoEditado, { headers });
