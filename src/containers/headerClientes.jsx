...
const Header = () => {
  ...
  const cargarClientes = async () => {
    try {
      ...
      const response = await axios.get(
        "https://backendmitiendita.onrender.com/api/v1/clientes",
        { headers }
      );
  ...
  const eliminarCliente = async (id) => {
    try {
      ...
      await axios.delete(`https://backendmitiendita.onrender.com/api/v1/clientes/${id}`, {
        headers,
      });
  ...
  const editarCliente = async (id, clienteEditado) => {
    try {
      ...
      await axios.patch(
        `https://backendmitiendita.onrender.com/api/v1/clientes/${id}`,
        clienteEditado,
        { headers }
      );
